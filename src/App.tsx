...
const FAQS = [
  ...
  ['Do I still need an outdoor antenna?', 'Yes. An outdoor antenna and its cable are required. The antenna built into Plidépli is the indoor antenna, which means internal mode does not need a separate indoor antenna or its cable run.'],
