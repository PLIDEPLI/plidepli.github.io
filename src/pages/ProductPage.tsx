...
const GALLERY = [
  ...
  ['standing', 'Standing view', 'Plidépli standing upright with connected antenna cables'],
  ['connected', 'Connections', 'Close view of the Plidépli housing and connected cables'],
  ['board-inside', 'Inside the housing', 'Plidépli circuit board and shielding inside the open housing'],
]
const MODES = [
...
export default function ProductPage() {
  ...
  return <>
    ...
    <section className="page-crosslink"><div className="container"><div><p className="eyebrow">Meet the team behind it</p><h2>There’s a story<br />inside this hardware.</h2></div><p>Follow the prototypes, the tuning, and the decisions that brought Plidépli to this point.</p><a className="button button-dark" href={`${BASE}stories/`}>Read our full story<Icon name="arrow" /></a></div></section>
