...
export default function HomeBench() {
  ...
  return <section className="section story-section bench-section" id="story"><div className="container">
    <div className="bench-opening">
      ...
      <div className="bench-introduction">
        ...
        <p>We're a small RF team in Shenzhen. Between us we've designed and tuned RF systems for base stations, phones, drones, and radar. This green anti-static bench — oscilloscope, spectrum analyzer, and all — is where Plidépli is built, and where most of the footage you'll see comes from.</p>
    ...
    <figure className="bench-photograph"><button type="button" onClick={() => setPhotoOpen(true)} aria-label="Enlarge our Shenzhen RF workbench photo"><img src={`${BASE}bench/workbench.webp`} alt="Our green anti-static workbench in Shenzhen, with RF instruments and Plidépli prototypes" width="1600" height="1200" loading="lazy" /><span>Explore the workbench<Icon name="plus" /></span></button><figcaption><span>The bench behind Plidépli.</span><span>Shenzhen · Original team photograph</span></figcaption></figure>
  ...
  </div>{photoOpen && <PhotoViewer photos={[{ src: `${BASE}bench/workbench.webp`, alt: 'The Plidépli RF workbench in Shenzhen. Original team photograph.' }]} initial={0} onClose={() => setPhotoOpen(false)} />}</section>
}
