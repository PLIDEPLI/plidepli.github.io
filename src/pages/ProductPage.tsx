...
import { CAMPAIGN_PRICE, EARLY_BIRD_SAVING, LATER_PRICE } from '../product-info'
...
export default function ProductPage() {
  ...
  return <>
    <section className="product-page-hero" id="top"><div className="container">
      ...
      </div><div className="product-detail-copy"><p className="eyebrow">Plidépli cellular signal booster</p><h1 className="phrase-heading"><span>A stronger connection.</span><span>A simpler setup.</span></h1><p className="product-lede">Bring your existing outdoor cell signal inside, with the indoor antenna built right into the booster.</p><div className="product-price"><strong>{CAMPAIGN_PRICE}</strong><span>Early-bird price · <s>{LATER_PRICE}</s> later price · {EARLY_BIRD_SAVING}</span></div><a className="button button-dark" href="#cta">Notify me at launch<Icon name="arrow" /></a><ul className="product-points"><li><Icon name="check" />Desk-friendly design</li><li><Icon name="check" />Flexible internal & external antenna switching</li><li><Icon name="check" />North American standard five bands</li><li><Icon name="check" />FCC certified</li></ul></div></div>
    </div></section>
