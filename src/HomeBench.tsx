...
export default function HomeBench() {
  ...
  return <section className="section story-section bench-section" id="story"><div className="container">
    ...
    <div className="bench-films bench-film-single"><figure>
      <video controls playsInline preload="none" poster={`${BASE}story-edits/home/poster.webp`} src={`${BASE}story-edits/home/film.mp4`} aria-label="At the tuning bench — 30-second film" onPlay={pauseOthers} />
