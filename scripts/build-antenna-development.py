...
run('ffmpeg','-hide_banner','-loglevel','error','-y','-ss','1','-i',source,'-loop','1','-i',TMP/'captions.png','-filter_complex','[0:v]transpose=cclock,scale=1280:720:force_original_aspect_ratio=decrease,pad=1280:720:(ow-iw)/2:(oh-ih)/2:color=0x071e2d,fps=24,setsar=1[v];[v][1:v]overlay=0:0[out]','-map','[out]','-an','-t','12','-c:v','libx264','-preset','fast','-crf','20','-pix_fmt','yuv420p',TMP/'tuning.mp4')
